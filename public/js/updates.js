...
var updates = [

		{
			...
			"updates": [
				...
				"New: Mouse's new Sewable Tech course is now on Mouse Create! There is more information about this course and all other Mouse courses in the <a href='/course-directory/'>Course Directory."
			]
		}, {
			"date": "7/21/17",
			"title": "Release: My Work",
			"updates": [
			...
			"date": "5/25/17",
			"title": "Release: Comments and Notifications",
			"updates": [
			...
			"date": "2/7/17",
			"title": "Release: Navigation Changes, Group and Member management updates and Responsive Layout",
			"updates": [
			...
			"date": "9/9/2016: Soft Launch of Mouse Create (Beta)",
			"updates": [
